  ...
  return (
    <section className="flex flex-col-reverse md:flex-row items-center justify-around gap-8 px-4 md:px-16 py-10 bg-white">
      ...
      <div className="flex flex-col items-start text-center md:text-left max-w-xl">
        ...
        <div className="mt-20 self-center justify-between flex flex-col md:flex-row items-center mt-6 space-y-4 md:space-y-0 md:space-x-4">
        ...
        <h2 className="text-4xl md:text-4xl  mt-30 text-center font-bold leading-snug">
